...
-- --------------------------
INSERT INTO `access_audit_actions` (`pk_action_id`, `action_description`)
...
-- --------------------------
INSERT INTO `access_audit_reports` (`pk_report_id`, `fk_username`, `fk_document_id`, `fk_action_id`, `action_date`)
