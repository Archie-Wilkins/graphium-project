...
public class DocumentsDatabaseStoringTests {
    ...
    public void canStorePDFDocumentAndReadMetadata() throws Exception {
        ...
        ReturnError storeResult = storeFileService.storeFile("Document Title", "testUser", fileToUpload.getOriginalFilename().split("[.]")[1], fileToUpload);
    ...
    public void canNotStoreDuplicateTitlesWithSameUser() throws Exception {
        ...
        ReturnError firstStoreResult = storeFileService.storeFile("Document Title","testUser", fileToUpload.getOriginalFilename().split("[.]")[1], fileToUpload);
        assertEquals(false, firstStoreResult.errored());
        // Storing second document
        ReturnError secondStoreResult = storeFileService.storeFile("Document Title","testUser", fileToUpload.getOriginalFilename().split("[.]")[1], fileToUpload);
    ...
    public void canStoreDuplicateTitlesWithDifferentUser() throws Exception {
        ...
        assertEquals(false, firstStoreResult.errored());
        // Storing first document
        ReturnError secondStoreResult = storeFileService.storeFile("Document Title","testUser2", fileToUpload.getOriginalFilename().split("[.]")[1], fileToUpload);
    ...
    public void canNotStoreInvalidFileType() throws Exception {
        ...
        ReturnError StoreResultOne = storeFileService.storeFile("Document Title","testUser", "jpg", fileOne);
        ...
        ReturnError StoreResultTwo = storeFileService.storeFile("Document Title","testUser", "pdf", fileTwo);
